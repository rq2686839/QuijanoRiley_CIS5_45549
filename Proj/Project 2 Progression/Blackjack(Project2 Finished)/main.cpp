 ...
 * Created on July 26, 2017, 7:24AM
...
#include <fstream>      //Stream for Writing to and Reading from Filesshow
...
int main(int argc, char** argv) {
    ...
    float, insBet;                     // insBet is the amount of the insurance
    ...
    saveMny.open("Moneyamounts.txt"); //This opens the file 
     ...
     for (short int i = 0; i < playCnt; i++)
     {
        ...
        {    
            ...
            } //Closes the { started in line 495
            ...
            else //If there are not more games to be played
            {
                ...
                /*Use a linear search to search the player's end-game hand values for
                 21 to display if the player ever got 21 or not*/

                //Use the classic linear search method to search for the value 21
                ...
                while (index < gameCnt && !found)
                {
                   if (playTot[index] == 21) //If 21 is found
                   {
            ...
            //Call the function that keeps track of the total amount of games 
            gameTot();
        } //Closes the { started in line 178  
    } //Closes the { started in line 163  
    ...
    if(display)
    {
        ...
        //Call the function to display number of games played
        cout<<endl;
        cout<<"This is over "<<gameTot() - 1<<" total games including games";
        cout<<"from all players.";
...
{
    /*Declare the variables that are used to assign values to each
...
/*This function keeps track of the total amount of games each time its called
 by using a static variable*/
int gameTot ()
{
    static int games = 0; //Initialize the static variable at 0
    games++;
    return games;
}