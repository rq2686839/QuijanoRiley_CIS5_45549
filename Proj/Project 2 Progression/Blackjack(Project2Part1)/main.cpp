 ...
 * Created on July 24, 2017, 5:55PM
...
int main(int argc, char** argv) {
                                                               ...
                                                               Blackjack*/                                                            
    {
        ...
        if (insBet != 0.0f) //If the player made an insurance bet
        ...
        switch (choice)
        {
            case 'A':
               /*Deal the next card for the player by copying the display 
                ...
                if (playTot > 21)           //  If the player has more than
                ...
                else if (playTot == 21)                  //If the player has 21, 
                {                                        //automatically stand 
                ...
                switch (choice)
                {
                    case 'A':
                        ...
                        else if (playTot == 21)                 //If player has 
                                                                 //21, 
                        {                                        //stand; 
    ...
    else //If there are not more games to be played
    {
        ...
        cout<<"This is "<<static_cast<unsigned short>(money[i][j]/500*CNVPERC);
    ...
    for(short int x = 1; x <= gameCnt; x++) /*Iterate for however many games 
                                             there are*/
    {
    ...
    /*Prompt the player to input if they want their average and standard deviation
