 ...
 * Created on July 20, 2017, 8:31AM
...
int main(int argc, char** argv) {
    ...
    saveMny<<money<<endl; /*This writes the money amount at the end of the game 
                           to the file;  all these values will be used in 
                           calculations at the end of the program*/
    ...
    for(short int j = 1; j <= gameCnt; j++) /*Iterate for however many games 
                                             there are*/
    {     
        amounts >> money; //Read in the money value for a game
        monyTot += money; //continuously add the money amounts
    }
    ...
    for(short int k = 1; k <= gameCnt; k++) /*Iterate for however many games 
                                             there are*/
    {
        amounts >> money; //Read in money value for a game
        
        meanDif = money - avg; //Difference between data point and average
    ...
    stdDev = sqrt(mDifTot/gameCnt);
    
    /*Prompt the user to input if they want their average and standard deviation
     of their money amounts at the end of each game to be displayed*/
    
    cout<<"Would you like the average money amount you had at the end of"<<endl;
    cout<<"each game and the standard deviation of your end game money"<<endl;
    ...
    if(display)
    {
        cout<<"The average money amount you had at the end of each game = $";
        cout<<avg;
        cout<<endl;
        cout<<"The standard deviation of the amounts you had at the end of ";
